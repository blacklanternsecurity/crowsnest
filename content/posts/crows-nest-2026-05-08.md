...
- [Defender for Endpoint: restrict response actions on high-value assets](https://learn.microsoft.com/en-us/defender-endpoint/restrict-response-actions-high-value-assets) by Sean Metcalf.
...
- [AAD Graph activity logs land in Azure Monitor](https://learn.microsoft.com/en-us/azure/azure-monitor/reference/tables/aadgraphactivitylogs) by Alberto Verza.
...
- [UK AISI evaluates GPT-5.5 cyber capabilities](https://www.aisi.gov.uk/blog/our-evaluation-of-openais-gpt-5-5-cyber-capabilities) by DANΞ.
...
- [Defender removes DigiCert AuthRoot registry entries](https://bugzilla.mozilla.org/show_bug.cgi?id=2033170) by Florian Roth ⚡️.
...
- [Dirty Frag: universal Linux LPE chaining xfrm-ESP and rxrpc](https://dirtyfrag.io/) by Dominic Chell 👻.
...
- [Chrome silently installs a 4 GB Gemini Nano model](https://awesomeagents.ai/news/chrome-gemini-nano-silent-install) by Simone Margaritelli.
...
- [TAPOcalypse Now: exploiting TP-Link smart devices](https://labs.taszk.io/articles/post/tapocalypse) by Gergely Kalman.
...
- [LAB52: 142-page EasterBunny report on APT29](https://lab52.io/blog/easterbunny) by hasherezade.
...
- [Bypassing Windows authentication reflection mitigations](https://www.synacktiv.com/en/publications/bypassing-windows-authentication-reflection-mitigations-for-system-shells-part-1) by Aurélien Chalot.
...
- [VS Code Dev Tunnels: the accidental C2 framework](https://specterops.io/blog/2026/05/06/dev-tunnels-the-accidental-c2) by N7WEra.
...
- [cPanel/WHM auth bypass CVE-2026-41940](https://labs.watchtowr.com/the-internet-is-falling-down-falling-down-falling-down-cpanel-whm-authentication-bypass-cve-2026-41940?123=) by SinSinology.
...
- [OpenAI on the origin of frontier-model jailbreaks](https://openai.com/index/where-the-goblins-came-from) by K̵i̵r̵k̵ ̵T̵r̵y̵c̵h̵e̵l̵.
...
- [KernelToUserInjector dodges ETW threat-intelligence sensors](https://github.com/winterknife/EVENSTAR/tree/master/KernelToUserInjector) by winterknife 🌻.
...
- [Codex on the wire: agent features as tradecraft](https://www.originhq.com/blog/codex-on-the-wire) by winterknife 🌻.
...
- [DSCourier: WinGet COM API as a post-exploitation primitive](https://eclipsesec.com/posts/DSCourier) by Bad Sector Labs.
...
- [Goodbye secure pool, hello KDP pool](https://windows-internals.com/goodbye-secure-pool-hello-kdp-pool) by chompie.
...
- [ARP around and find out: hijacking GPO UNC paths](https://trustedsec.com/blog/arp-around-and-find-out-hijacking-gpo-unc-paths-for-code-execution-and-ntlm-relay?hss_channel=tw-403811306) by codewhisperer84.
...
- [Kerberos with Titanis: walking the auth flow](https://trustedsec.com/blog/kerberos-with-titanis?hss_channel=tw-403811306) by codewhisperer84.
...
- [MCP server OAuth registration is wide open](https://openyoutu.be/wyxveABHu3I) by Arun.
...
- [EDR internals research and bypass](https://0xdbgman.github.io/posts/edr-internals-research-and-bypass) by Arun.
...
- [SpecterOps: what red team actually means](https://ghst.ly/4uk1qaj) by Arun.
...
- [The defensive stack is exposed](https://trustedsec.com/blog/the-defensive-stack-is-exposed) by d3d aka dead (dead, мёртв, 死了).
...
- [dMSA Ouroboros: self-sustaining credential extraction on Server 2025](https://www.huntress.com/blog/dmsa-ouroboros-credential-extraction-windows-server-2025) by Andrea P.
...
- [Trail of Bits beats Google's zero-knowledge proof of quantum cryptanalysis](https://blog.trailofbits.com/2026/04/17/we-beat-googles-zero-knowledge-proof-of-quantum-cryptanalysis) by Dan Guido.
...
- [Linux LPE wave: copy.fail across major distros](https://xint.io/blog/copy-fail-linux-distributions) by Gergely Kalman.
...
- [MAD Bugs: 21-year-old PHP unserialize use-after-free](https://open.substack.com/pub/calif/p/mad-bugs-finding-and-exploiting-a?r=26yra9&amp%3Butm_campaign=post&amp%3Butm_medium=web) by Stefan Esser.
...
- [BlackArrow opens up its talks repository](https://github.com/blackarrowsec/talks) by BlackArrow.
> BlackArrow opens up the materials from every talk they have given. Slides, PoCs, and code in one repo.

- [Invoke-ADLabBuildOut adds AD sites and subnets](https://github.com/PyroTek3/ADLab) by Sean Metcalf.
...
- [MSSQLHound rewritten in Go](https://github.com/Mayyhem/MSSQLHound) by S3cur3Th1sSh1t.
...
- [SOAPy gains Kerberos auth over ADWS](https://github.com/logangoins/SOAPy) by Logan Goins.
...
- [net_use BOF: drive mapping without net.exe](https://github.com/atomiczsec/Adrenaline/tree/main/community/net_use) by Adam Chester 🏴‍☠️.
...
- [mona v3 released](https://github.com/corelan/mona3) by ς๏гєɭคภς0๔3г (corelanc0d3r@infosec.exchange).
...
- [claude-red: offensive-security skills for Claude](https://github.com/SnailSploit/Claude-Red) by Jason Lang.
...
- [Puzzle: malware via Windows minifilter abuse](https://github.com/Kudaes/Puzzle) by hasherezade.
...
- [Microsoft EventLogExpert: an improved Event Viewer](https://github.com/microsoft/EventLogExpert) by Chris Nickerson.
